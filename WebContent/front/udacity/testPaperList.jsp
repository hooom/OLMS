	...
	<div class="row-fluid course-catalog-content ng-scope" data-ng-controller="courseCatalog">
		...
		<div class="l-crs-li">
			<ul id="unfiltered-class-list" class="crs-li">
				...
				<s:iterator value="testPapersByCourse" var="tp">

			<li data-ng-show="isCourseShown('ma006')" style="">
					<s:url action="testPaperExamInput" namespace="front" var="testPaperDetailInputLink">
						<s:param name="testPaperID">${tp.testPaperID}</s:param>
					</s:url>
					<a href="../${testPaperDetailInputLink}">
						<div class="crs-li-info">
							<div class="crs-li-name-and-tags">
								<div class="crs-li-name">
									<div class="crs-li-title">${tp.testPaperName}</div>
								</div>
								<div class="crs-li-tags">
									<div class="crs-li-tags-category"></div>
