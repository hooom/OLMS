...
<%@ taglib prefix="s" uri="/struts-tags" %>
    ...
    <div id="midpart">
		...
		<table width="100%" class="pn-ftable" cellpadding="2" cellspacing="1" border="0">
		 ...
		 <s:form action="courseAdd" method="post" enctype="multipart/form-data">
		 	<s:textfield key="course.courseName" />
		 	<s:textarea key="course.requireKnowledge" />
		 	<s:textarea key="course.gain" />
		 	<s:file key="introVideo" />
		 	<s:file key="introPicture" />
		 	<s:textarea key="course.description" />
		 	<s:select key="course.level" list="levels" />
